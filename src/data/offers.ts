export const Offers = [
  {
    label: "Montaż i modernizacja instalacji elektrycznych",
    href: "/uslugi/montaz-i-modernizacja-instalacji-elektrycznych",
  ...
  {
    label: "Urządzenia w wykonaniu przeciwwybuchowym",
    href: "/uslugi/urzadzenia-w-wykonaniu-przeciwwybuchowym",
    desc: "W ramach naszych usług oferujemy montaż i serwis elektrycznych urządzeń w wykonaniu przeciwwybuchowym.",
  },
  {
    label: "Serwis i konserwacja urządzeń elektrotermicznych",
    href: "/uslugi/serwis-i-konserwacja-urzadzen-elektrotermicznych",
  ...
  {
    label: "Instalacja i konserwacja oświetlenia ulicznego",
    href: "/uslugi/instalacja-i-konserwacja-oswietlenia-ulicznego",
