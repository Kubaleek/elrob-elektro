...
const Drawer = ({ shouldScaleBackground = true, direction = "left", ...props }: React.ComponentProps<typeof DrawerPrimitive.Root>) => (
...
const drawerContentVariants = cva("fixed z-50 flex h-auto flex-col border bg-background", {
  variants: {
    direction: {
      right: "ml-24 right-0 w-full rounded-l-[10px] inset-y-0",
      top: "mb-24 top-0 rounded-b-[10px] inset-x-0",
      bottom: "mt-24 rounded-t-[10px] bottom-0 inset-x-0",
      left: "mr-24 w-4/4 left-0 rounded-r-[10px] inset-y-0",
    },
  },
  defaultVariants: {
    direction: "left",
