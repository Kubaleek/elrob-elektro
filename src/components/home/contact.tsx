        ...
        <div className="p-6 py-16">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="leading-relaxed text-[#c0c0c0]">
              Masz pytania, potrzebujesz wyceny lub chcesz umówić termin realizacji? Skontaktuj się z nami! EL-ROB chętnie odpowie na wszelkie wątpliwości i doradzi najlepsze rozwiązania
              dopasowane do Twoich potrzeb. Działamy sprawnie, fachowo i z pełnym zaangażowaniem jesteśmy tu, by Ci pomóc.
            </p>
          </div>
