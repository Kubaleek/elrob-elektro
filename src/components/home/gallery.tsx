        ...
        <div className="p-6">
          ...
          <div className="flex flex-col gap-1 mt-5 border-b border-dashed border-neutral-400 pb-4">
            ...
            <p className="text-base leading-relaxed">
              Każde zlecenie realizujemy z pełnym zaangażowaniem, łącząc fachową wiedzę z najwyższymi standardami bezpieczeństwa. Satysfakcja klienta jest dla nas priorytetem, dlatego dbamy o każdy
              detal na każdym etapie współpracy.
            </p>
          </div>
